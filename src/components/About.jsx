...
const stats = [
  ...
  { value: 5, suffix: 'k+', label: 'GitHub Commits', gradient: 'from-amber-500 to-orange-500' },
]

const highlights = [
  { icon: MapPin, text: 'Based in Ado Ekiti, Nigeria', color: 'from-violet-600 to-indigo-600' },
  { icon: Coffee, text: 'Fuelled by coffee and curiosity', color: 'from-amber-500 to-orange-500' },
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-16 sm:mb-20">
          ...
          <div ref={leftRef} className={`flex justify-center lg:justify-start reveal-left ${leftVisible ? 'visible' : ''}`}>
            <div className="relative">
              ...
              <div className="relative w-56 h-56 sm:w-72 sm:h-72 rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-600 flex items-center justify-center text-7xl sm:text-8xl select-none shadow-2xl shadow-violet-500/30 animate-float">
                👩‍💻
              </div>
              {/* Floating badge */}
